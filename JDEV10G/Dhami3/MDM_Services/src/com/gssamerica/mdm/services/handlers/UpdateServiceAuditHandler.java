...
public class UpdateServiceAuditHandler implements Handler {
    private QName[] headerNames = null;
    
    public UpdateServiceAuditHandler() {
    }
    
    public QName[] getHeaders() {
        System.out.println("[UpdateServiceAuditHandler] getHeaders method called..");
        return new QName[0];
    }

    public boolean handleRequest(MessageContext messageContext) {
        System.out.println("[UpdateServiceAuditHandler] handleRequest method called..");
        ...
        try {
            ...
            xpathRemoteSource = "//" + XPATHConstants.SOAP_ENVELOPE + "/" + 
                                  ...
                                  XPATHConstants.UpdateRecordRequest + "/" + 
            ...
            System.out.println("[UpdateServiceAuditHandler] XPath Source - " + remoteSource);
            System.out.println("[UpdateServiceAuditHandler] XPath transactionId is - " + transactionId);
            System.out.println("[UpdateServiceAuditHandler] XPath userId is - " + userId);
            ...
            mdmAudit.setProcessName(MDMConstants.PROCESS_UPDATERECORD_SERVICES);
            ...
            mdmAudit.setProcessDescription(MDMConstants.PROCESS_DESC_UPDATERECORD_SERVICES);
    ...
    public boolean handleResponse(MessageContext messageContext) {
        System.out.println("[UpdateServiceAuditHandler] handleResponse method called..");
        return true;
    }

    public boolean handleFault(MessageContext messageContext) {
        System.out.println("[UpdateServiceAuditHandler] handleFault method called..");
        return true;
    }

    public void init(HandlerInfo handlerInfo) {
        System.out.println("[UpdateServiceAuditHandler] init method called..");
        headerNames = new QName[0];
    }

    public void destroy() {
        System.out.println("[UpdateServiceAuditHandler] destroy method called..");
    }
}
