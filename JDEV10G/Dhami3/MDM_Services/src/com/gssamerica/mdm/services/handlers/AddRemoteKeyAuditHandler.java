...
public class AddRemoteKeyAuditHandler implements Handler {
    
    private QName[] headerNames = null;
    
    public AddRemoteKeyAuditHandler() {
    }
    
    public QName[] getHeaders() {
        System.out.println("[AddRemoteKeyAuditHandler] getHeaders method called..");
        return new QName[0];
    }
    
    public boolean handleRequest(MessageContext messageContext) {
        System.out.println("[AddRemoteKeyAuditHandler] handleRequest method called..");
        ...
        try {
            ...
            xpathRemoteSource = "//" + XPATHConstants.SOAP_ENVELOPE + "/" + 
                                  ...
                                  XPATHConstants.AddRemoteKeyRequest + "/" + 
            ...
            System.out.println("[AddRemoteKeyAuditHandler] XPath Source - " + remoteSource);
            System.out.println("[AddRemoteKeyAuditHandler] XPath transactionId is - " + transactionId);
            System.out.println("[AddRemoteKeyAuditHandler] XPath userId is - " + userId);
            ...
            mdmAudit.setProcessName(MDMConstants.PROCESS_ADDREMOTEKEY_SERVICES);
            ...
            mdmAudit.setProcessDescription(MDMConstants.PROCESS_DESC_ADDREMOTEKEY_SERVICES);
    ...
    public boolean handleResponse(MessageContext messageContext) {
        System.out.println("[AddRemoteKeyAuditHandler] handleResponse method called..");
        return true;
    }

    public boolean handleFault(MessageContext messageContext) {
        System.out.println("[AddRemoteKeyAuditHandler] handleFault method called..");
        return true;
    }

    public void init(HandlerInfo handlerInfo) {
        System.out.println("[AddRemoteKeyAuditHandler] init method called..");
        headerNames = new QName[0];
    }

    public void destroy() {
        System.out.println("[AddRemoteKeyAuditHandler] destroy method called..");
    }
}
