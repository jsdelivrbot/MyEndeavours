...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [FRI MAR 06 13:37:10 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
  <!-- <xsl:variable name="source" select="'ORACLEB2B'"/>
    <xsl:variable name="destination" select="'Oagisdummy'"/>
