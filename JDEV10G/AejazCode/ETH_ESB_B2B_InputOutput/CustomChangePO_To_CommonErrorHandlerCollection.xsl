...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [THU APR 30 14:31:10 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns1="http://oracle.com/esb/namespaces/ETHSys_IntegrationServices_ETHSysGrp_ChangePurchaseOrder"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath"
                xmlns:ns4="http://www.openapplications.org/oagis/9"
                xmlns:hdr="http://xmlns.oracle.com/pcbpel/adapter/jms/"
                exclude-result-prefixes="xsl ns6 ns2 ns0 ns7 ns9 inp1 ns5 ns8 ns3 ns1 ns4 tns plt jca imp1 hdr ehdr xp20 ora orcl bpws hwf xref ids">
  <xsl:template match="/">
    ...
    <imp1:CommonErrorHandlerCollection>
      <imp1:CommonErrorHandler>
        ...
        <imp1:sourceName>
          <xsl:value-of select='string("RS_B2B_ChangePO")'/>
        </imp1:sourceName>
        ...
        <imp1:inPayload>
          <xsl:value-of select="orcl:get-content-as-string(/inp1:CustomChangePO)"/>
        </imp1:inPayload>
      </imp1:CommonErrorHandler>
    </imp1:CommonErrorHandlerCollection>
  </xsl:template>
