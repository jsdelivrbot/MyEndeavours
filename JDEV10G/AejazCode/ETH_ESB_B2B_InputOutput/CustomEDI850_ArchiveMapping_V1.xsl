...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED APR 08 16:48:56 IST 2009]. -->
?>
   ...
   <xsl:template match="/">
     ...
     <imp1:RootElement>
      <ScMasterTransaction>
        ...
        <xsl:if test="/CustomEDI850/Attribute5 = 'TP1'">  
            <flowId3>
        ...
        <xsl:choose>
            <xsl:when test="/CustomEDI850/Sender_Transaction_subtype ='POCO'"> 
     ...
     <!--  <attribute6>
          <xsl:value-of select="/CustomEDI850/Attribute6"/>
        </attribute6>  -->
      </ScMasterTransaction>
      <scDetailedTransaction>
        ...
        <transactionType>
          <xsl:text disable-output-escaping="no">EDI_850_V5020</xsl:text>
        </transactionType>
        <payload>
           <xsl:value-of select="orcl:get-content-as-string(/CustomEDI850/Transaction-850)"/>
        </payload>
        <businessDocumentID>
          <xsl:value-of select="/CustomEDI850/Sender_Document_number"/>
        </businessDocumentID>
        <source>
        ...
        <xsl:choose>
                ...
                <!-- Added below code for TP3, TP4, TP5 -->
                 <xsl:when test="/CustomEDI850/Attribute5 ='TP3'"> 
                  <destinationSystem>
                      <xsl:value-of select="/CustomEDI850/Trading_partner_3_name"/>
                      </destinationSystem>
                 </xsl:when>
                 
                  <xsl:when test="/CustomEDI850/Attribute5 ='TP4'"> 
                  <destinationSystem>
                      <xsl:value-of select="/CustomEDI850/Logistics_1_name"/>
                      </destinationSystem>
                 </xsl:when>
                 
                  <xsl:when test="/CustomEDI850/Attribute5 ='TP5'"> 
                  <destinationSystem>
                      <xsl:value-of select="/CustomEDI850/Logistics_2_name"/>
                      </destinationSystem>
                 </xsl:when>
            <xsl:otherwise>
            <destinationSystem>
    ...
    <!-- <destinationSystem>
     ...
     <destinationFlowID>
        ...
        <XMLConfirmBODNumber>
         <xsl:value-of select="/CustomEDI850/Attribute7"/>
        </XMLConfirmBODNumber>
      </scDetailedTransaction>
    </imp1:RootElement> 
  </xsl:template> 
