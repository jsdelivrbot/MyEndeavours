...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [THU SEP 24 16:04:08 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns10="urn:oracle:integration:b2b:5DBD819D1FC74E2884B368A5B7392F9F"
                ...
                xmlns:ns9="http://xmlns.oracle.com/pcbpel/adapter/file/ETH_PUTFL_EDI_Output_860V1_0/"
                xmlns:ns3="http://www.openapplications.org/oagis/9"
                exclude-result-prefixes="xsl ns5 tns ns1 ns0 ns6 ns8 inp1 ns4 ns7 ns2 ns3 plt jca ns10 hdr imp1 ns9 ehdr xp20 ora orcl bpws eth hwf xref ids">
  <xsl:template match="/">
    <inp1:CustomEDI860>
     <xsl:variable name="SC_SeqNo">  
      ...
      <xsl:variable name="destination">
        <xsl:choose>
            ...
            <xsl:when test="/inp1:CustomChangePO/Attribute5 ='TP3'">
                <xsl:value-of select="/inp1:CustomChangePO/Trading_partner_3_name"/>
	    </xsl:when> 
	    <xsl:when test="/inp1:CustomChangePO/Attribute5 ='TP4'">
                <xsl:value-of select="/inp1:CustomChangePO/Logistics_1_name"/>
	    </xsl:when> 
	    <xsl:when test="/inp1:CustomChangePO/Attribute5 ='TP5'">
                <xsl:value-of select="/inp1:CustomChangePO/Logistics_2_name"/>
            </xsl:when> 
            <xsl:otherwise>
   ...
   <!-- <xsl:variable name="flowID">  
    ...
    <ns10:Internal-Properties>
      ...
      <ns10:Segment-ST>      
        <ns10:Element-143>
          <xsl:value-of select="string(860.0)"/>
        </ns10:Element-143>
       <!-- <ns10:Element-329>
      ...
      <ns10:Segment-BCH>
        ...
        <!--Added On 15 DEC-->        
        <xsl:if test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode !=''">
        <xsl:choose>
         <xsl:when test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode='Cancel'">
            <ns10:Element-353>
              <xsl:value-of select='string("01")'/>
            </ns10:Element-353>
        </xsl:when>
       <xsl:when test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode ='Change'">
            <ns10:Element-353>
              <xsl:value-of select='string("04")'/>
            </ns10:Element-353>
        </xsl:when>
        <xsl:when test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode ='Replace'">
            <ns10:Element-353>
                <xsl:value-of select='string("05")'/>
            </ns10:Element-353>
        </xsl:when>
        <xsl:when test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode ='Delete'">
            <ns10:Element-353>
        ...
        <xsl:otherwise>
            <ns10:Element-353>
              <xsl:value-of select='/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode'/>
            </ns10:Element-353>
        </xsl:otherwise>
        </xsl:choose>
        </xsl:if>
      ...
      <xsl:for-each select="/imp1:CustomChangePO/ChangePO/ns3:ApplicationArea/ns3:Sender">
        <ns10:Segment-REF>
          ...
          <ns10:Element-127>
            <xsl:value-of select='string("EMR860V1.0")'/> <!-- ADDED AS ON 25 SEP -->
          </ns10:Element-127>
        </ns10:Segment-REF>
      </xsl:for-each> 
 ...
 <!--</xsl:for-each>-->
      ...
      <!-- Updated on 09 Sep 2009 - SC_Phase3 -->
        ...
        <xsl:choose>
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:FreightTermCode = 'Prepaid')">
                <ns10:Element-146>       
                  <xsl:value-of select='string("PP")'/>
                </ns10:Element-146>
            </xsl:when>
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:FreightTermCode = 'Collect')">
                <ns10:Element-146>       
                  <xsl:value-of select='string("CC")'/>
                </ns10:Element-146>
            </xsl:when>
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:FreightTermCode = 'Customer Pickup')">
                <ns10:Element-146>       
                  <xsl:value-of select='string("PB")'/>
                </ns10:Element-146>
            </xsl:when>
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:FreightTermCode = 'Defined by Buyer and Seller')">
                <ns10:Element-146>       
          ...
          <xsl:if test="ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode != ''">
           <xsl:choose>
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 EXW')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 FCA')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 CPT')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 CIP')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 DAF')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 DDU')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 DDP')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 FAS')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 FOB')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 CFR')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 CIF')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 DES')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
            ...
            <xsl:when test="(ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'INCO2000 DEQ')">
                <ns10:Element-334>
                  <xsl:value-of select="string('01')"/>
                </ns10:Element-334>
                <ns10:Element-335>
        ...
        <!--<xsl:if test="/imp1:CustomChangePO/ChangePO/ns3:ApplicationArea/ns3:Sender/ns3:LogicalID ='LIEBERTNA'">--> <!-- Removed on 12 Sep 2009 - SC_Phase3 -->
        ...
        <xsl:choose>
            <xsl:when test="((ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'UCC FOB ORIGIN PPD') or (ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'UCC FOB ORIGIN COL'))">                
                <ns10:Element-54>
                  <xsl:value-of select="string('BY')"/>
                </ns10:Element-54>
            </xsl:when>
            <xsl:when test="((ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'UCC FOB DEST PPD') or (ns3:PurchaseOrderHeader/ns3:TransportationTerm/ns3:IncotermsCode = 'UCC FOB DEST COL'))">                
                <ns10:Element-54>
    ...
    <xsl:if test="(ns3:PurchaseOrderHeader/ns3:Note[1] != '') or (ns3:PurchaseOrderHeader/ns3:Note[2] != '') or (ns3:PurchaseOrderHeader/ns3:Description != '')">
        ...
        <!-- Added 12 Sep 2009 - SC_Phase3 -->
        <xsl:if test='ns3:PurchaseOrderHeader/ns3:Description !=""'>
            <ns10:Segment-MTX_1>
              <ns10:Element-363_1>
                <xsl:value-of select='string("OTH")'/>
              </ns10:Element-363_1>
               <ns10:Element-1551_2>
                <xsl:value-of select="normalize-space(ns3:PurchaseOrderHeader/ns3:Description)"/>
              </ns10:Element-1551_2>
            </ns10:Segment-MTX_1>
        </xsl:if>
        <!-- Added 12 Sep 2009 - SC_Phase3 -->
        
        <xsl:if test="(ns3:PurchaseOrderHeader/ns3:Note[1] != '') or (ns3:PurchaseOrderHeader/ns3:Note[2] != '')">
            <ns10:Segment-MTX_1>
              <ns10:Element-363_1>
                <xsl:value-of select='string("OTH")'/>
              </ns10:Element-363_1>
         ...
         <xsl:if test="ns3:Name[2] != '' or ns3:Name[3] != ''">
          ...
          <xsl:if test="(ns3:Location/ns3:Address/ns3:CityName !='')">
           ...
           <!-- <xsl:if test='((ns3:Location/ns3:Address/ns3:CountryCode = "US") or (ns3:Location/ns3:Address/ns3:CountryCode = "CA"))'>
            ...
            -->
            <!-- Postal Code Change incorporated on 4Feb2010 -->
            
                     <xsl:choose>
                            <xsl:when test='contains(ns3:Location/ns3:Address/ns3:PostalCode,"-") and (ns3:Location/ns3:Address/ns3:PostalCode != "")'>
                            
                                <ns10:Element-116>
                                  <xsl:value-of select="translate(ns3:Location/ns3:Address/ns3:PostalCode,'-','')"/>
                                </ns10:Element-116>
                            ...
                            <xsl:when test='contains(ns3:Location/ns3:Address/ns3:PostalCode," ") and (ns3:Location/ns3:Address/ns3:PostalCode != "")'>
                             ...
                             <xsl:when test='((ns3:Location/ns3:Address/ns3:PostalCode = "") and (ns3:Location/ns3:Address/ns3:CityName != ""))'>
                                <ns10:Element-116>
 ...
 <!-- Added choose when condition on April-24 2009 to convert contrydivision name  to  code-->
     ...
     <!-- BILLTO --> 
      ...
      <!--CARRIERPARTY-->
      <xsl:if test='ns3:PurchaseOrderHeader/ns3:CarrierParty/ns3:Name[1] != ""'>
      ...
      <ns10:Loop-POC>
        <xsl:for-each select="ns3:PurchaseOrderLine">
          <ns10:Segment-POC>
            ...
            <!-- Added 12 Sep 2009 - SC_Phase3 -->
            <xsl:choose>
             <xsl:when test="ns3:Status/ns3:ReasonCode='Add'">
                <ns10:Element-670>
                  <xsl:value-of select='string("AI")'/>
                </ns10:Element-670>
              </xsl:when>
              <xsl:when test="ns3:Status/ns3:ReasonCode='Cancel'">
                <ns10:Element-670>
                  <xsl:value-of select='string("DI")'/>
                </ns10:Element-670>
              </xsl:when>
              <xsl:when test="ns3:Status/ns3:ReasonCode='Change'">
                <ns10:Element-670>
                  <xsl:value-of select='string("MU")'/>
                </ns10:Element-670>
              </xsl:when>
              <xsl:when test="ns3:Status/ns3:ReasonCode='Replace'">
                <ns10:Element-670>
                  <xsl:value-of select='string("RZ")'/>
                </ns10:Element-670>
              </xsl:when>
                <xsl:otherwise>
                    <ns10:Element-670>
            ...
            <!-- Added 12 Sep 2009 - SC_Phase3 -->                        
            <xsl:choose>
                <xsl:when test="ns3:OpenQuantity !=''">                    
                    <ns10:Element-671>                        
                        <xsl:value-of select="ns3:OpenQuantity"/>
                    </ns10:Element-671>
                </xsl:when>
                <xsl:otherwise>
                    <ns10:Element-671>
            ...
            <!-- Added 12 Sep 2009 - SC_Phase3 -->
            <ns10:Element-639_1>
                 <xsl:value-of select='orcl:lookup-dvm("Price_UnitOfMeasure","UOM",ns3:UnitPrice/ns3:PerQuantity/@unitCode,"EDI_Out",string("UM"))'/>
            </ns10:Element-639_1>
            <!-- Added 12 Sep 2009 - SC_Phase3 -->
        ...
        <ns10:Segment-TXI_1>
          <ns10:Element-963_1>
            <xsl:value-of select='string("ZZ")'/>
              ...
              <xsl:choose>                
                <xsl:when test="ns3:UserArea/ns3:Note = 'Y'">
                  <ns10:Element-441_1>
        ...
        <!-- Updated to use Segment-MTX_2 instead of Loop-LDT->Segment-MTX on 12 Sep 2009 - SC_Phase3 -->
        <xsl:if test='(ns3:Note[1] != "") or (ns3:Note[2] != "")'>
        <!--<ns10:Loop-LDT> --> <!-- Removed 12 Sep 2009 - SC_Phase3 -->
            <ns10:Segment-MTX_2>
                <ns10:Element-363_2>
        ...
        <!-- Updated on 12 Sep 2009 - SC_Phase3 -->
         ...
         <xsl:if test="ns3:UserArea/ns3:ShipToParty/ns3:Name[2] != '' or ns3:UserArea/ns3:ShipToParty/ns3:Name[3] != ''">
          ...
          <xsl:if test="(ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CityName !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountryCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountrySubDivisionCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:ID !='')">
           ...
           <!-- <xsl:if test='((ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountryCode ="US") or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountryCode ="CA"))'>
            ...
            <!-- Postal Code changes incorporated on 4Feb2010 -->
            
              <xsl:choose>
                            <xsl:when test='contains(ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode,"-") and (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode != "")'>
                            
                                <ns10:Element-116>
                                  <xsl:value-of select="translate(ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode,'-','')"/>
                                </ns10:Element-116>
                            ...
                            <xsl:when test='contains(ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode," ") and (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode != "")'>
                             ...
                             <xsl:when test='((ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode = "") and (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CityName != ""))'>
                                <ns10:Element-116>
                                  <xsl:value-of select='string("00000")'/>
                                </ns10:Element-116>
                              </xsl:when>
       ...
       <xsl:if test='((ns3:UserArea/ns3:ShipToParty/ns3:Contact[1]/ns3:Name !="") or (ns3:UserArea/ns3:ShipToParty/ns3:Contact[1]/ns3:Communication[3]/ns3:DialNumber != "") or (ns3:UserArea/ns3:ShipToParty/ns3:Contact[1]/ns3:Communication[2]/ns3:DialNumber !="") or (ns3:UserArea/ns3:ShipToParty/ns3:Contact[1]/ns3:Communication[1]/ns3:URI != ""))'> 
        ...
        <!-- Updated to use Segment-SCH_1 instead of Loop-SCH->Segment-SCH on 12 Sep 2009 - SC_Phase3 -->
        <!--<ns10:Loop-SCH>--> <!-- Removed 12 Sep 2009 - SC_Phase3 -->
          <ns10:Segment-SCH_1>
            <ns10:Element-380_2>
              <xsl:value-of select="ns3:Quantity"/>
            </ns10:Element-380_2>
