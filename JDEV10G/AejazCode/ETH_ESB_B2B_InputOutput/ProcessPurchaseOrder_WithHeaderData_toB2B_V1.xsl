  ...
  <xsl:variable name="source" select="'Emerson'"/>
    ...
    <xsl:variable name="destination">
        <xsl:choose>
            ...
            <!-- Added below code for TP3, TP4, TP5 -->
            <xsl:when test="/CustomProcessPO/Attribute5 ='TP3'">        
                <xsl:value-of select="/CustomProcessPO/Trading_partner_3_name"/>
            </xsl:when>
            
            <xsl:when test="/CustomProcessPO/Attribute5 ='TP4'">        
                <xsl:value-of select="/CustomProcessPO/Logistics_1_name"/>
            </xsl:when>
            
            <xsl:when test="/CustomProcessPO/Attribute5 ='TP5'">        
                <xsl:value-of select="/CustomProcessPO/Logistics_2_name"/>
            </xsl:when>
        </xsl:choose>
    </xsl:variable>
    ...
    <xsl:variable name="actionName" select="concat('contentType:application/octet-stream;filename:',/CustomProcessPO/Attribute7)"/>
