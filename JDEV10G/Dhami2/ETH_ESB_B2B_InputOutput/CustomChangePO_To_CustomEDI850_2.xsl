...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="Write_PUTFL_CustomEDI.wsdl"/>
      <rootElement name="CustomEDI850" namespace="http://xmlns.emrsn.com/CustomProcessPurchaseOrder"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE MAY 05 13:45:44 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                xmlns:ns9="http://xmlns.oracle.com/pcbpel/adapter/file/Write_PUTFL_CustomEDI/"
                ...
                xmlns:ns10="http://xmlns.emrsn.com/CustomProcessPurchaseOrder"
                ...
                xmlns:ns12="urn:oracle:integration:b2b:DCC1FCD2811C47748DF43A39F735F4F0"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath"
                xmlns:ns3="http://www.openapplications.org/oagis/9"
                xmlns:hdr="http://xmlns.oracle.com/pcbpel/adapter/jms/"
                exclude-result-prefixes="xsl ns5 plt ns1 jca ns0 tns ns6 ns8 imp1 pc ns4 ns7 ns2 ns3 hdr ns9 ns11 ns10 ns12 ehdr xp20 ora orcl bpws hwf xref ids">
  <xsl:template match="/">
      <ns10:CustomEDI850>
       <xsl:variable name="SC_SeqNo">  
        <xsl:value-of select="orcl:sequence-next-val('B2B_MSG_SEQ','jdbc/ETH_BusinessDB')"/>
      </xsl:variable>
     <ns12:Transaction-850>
   <!-- <xsl:variable name="flowID">  
      ...
      <ns12:Segment-BEG>
        ...
        </ns12:Element-353>--><!--Commented On 15 DEC--><!-- ADDED AS PER ROBIN'S MAIL ON 23 SEP -->
        <!--Added On 15 DEC-->
        <xsl:choose>
       ...
       <xsl:if test="/imp1:CustomChangePO/ChangePO/DataArea/ns3:Change/ns3:ActionCriteria/ns3:ActionExpression/@actionCode ='Change'">
        ...
        <ns12:Element-373>           <!-- ADDED AS ON 25 SEP -->        
  ...
  <!--  </xsl:for-each> -->
      ...
      <xsl:for-each select="ns3:PurchaseOrderHeader"> 
        <ns12:Segment-REF>
          <ns12:Element-128>
            <xsl:value-of select='string("K8")'/>  <!-- CHANGED ON 24 SEP -->
          </ns12:Element-128>
          <ns12:Element-352>
    ...
    <xsl:if test='ns3:PurchaseOrderHeader/ns3:DocumentID/ns3:RevisionID !=""'> <!-- ADDED AS ON 25 SEP -->   
             <ns12:Segment-REF>
          <ns12:Element-128>
            <xsl:value-of select='string("K9")'/>  <!-- CHANGED ON 24 SEP -->
          </ns12:Element-128>
          <ns12:Element-352>
            <xsl:value-of select="ns3:PurchaseOrderHeader/ns3:DocumentID/ns3:RevisionID"/> <!-- CHANGED ON 24 SEP -->
          </ns12:Element-352>
        </ns12:Segment-REF>
 ...
 <!--</xsl:for-each>-->
      ...
      <ns12:Segment-ITD>
        ...
        <ns12:Loop-N9><!-- ADDED AS ON 8 OCT "loop-n9" -->
        <xsl:if test="ns3:PurchaseOrderHeader/ns3:Note != ''">
        <ns12:Segment-N9>
          <ns12:Element-128>
        ...
        <ns12:Loop-N1>
         ...
         <!--   <xsl:if test="(ns3:Location/ns3:Address/ns3:CountrySubDivisionCode !='')"> -->
          ...
          <xsl:if test='((ns3:BuyerContact/ns3:Name !="") or (ns3:BuyerContact/ns3:Communication[3]/ns3:DialNumber != "") or (ns3:BuyerContact/ns3:Communication[2]/ns3:DialNumber != "") or (ns3:BuyerContact/ns3:Communication[1]/ns3:URI != ""))'><!-- ADDED AS ON 4 DEC "NAME CONDITION" -->
           <ns12:Segment-PER><!-- ADDED AS ON 25 SEP -->
                <ns12:Element-366>
       ...
       <ns12:Loop-N1_2>
        <ns12:Segment-N1>
          ...
          <xsl:if test="(ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CityName !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:PostalCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountryCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:Address/ns3:CountrySubDivisionCode !='') or (ns3:UserArea/ns3:ShipToParty/ns3:Location/ns3:ID !='')">
           <ns12:Segment-N4><!-- ADDED AS ON 23 OCT -->
