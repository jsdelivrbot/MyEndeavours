...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns5 ns2 ns0 ns6 ns8 inp1 ns7 ns4 tns ns3 imp1 plt jca obj1 ns9 ehdr xp20 ora orcl bpws hwf xref ids">
  <xsl:template match="/">
  ...
  <!--  <xsl:variable name="destination" select="/inp1:CustomChangePO/Trading_partner_1_name"/> -->
    ...
    <xsl:variable name="messageid" select="/inp1:CustomChangePO/Attribute6"/>
