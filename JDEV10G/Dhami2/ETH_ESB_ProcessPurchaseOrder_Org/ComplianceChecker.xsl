            ...
            <imp1:PurchaseOrder>
              ...
              <imp1:PurchaseOrderHeader>
                <imp1:DocumentID>
                  ...
                  <xsl:variable name="POID_Name">
                    <xsl:value-of select='orcl:lookup-dvm("SystemID","INSTANCE NUMBER Unique identifier",$POID_Sub,"Target",concat(imp1:PurchaseOrderHeader/imp1:DocumentID/imp1:ID,"COMPLIANCE_ERROR"))'/>
                  </xsl:variable>
              ...
              <imp1:Note>
                ...
                <imp1:SupplierParty>
                  <imp1:PartyIDs>
                    ...
                    <xsl:variable name="PartyID_Name">
                      <xsl:value-of select='orcl:lookup-dvm("SystemID","INSTANCE NUMBER Unique identifier",$PartyID_Sub,"Target",concat(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:PartyIDs/imp1:ID,"COMPLIANCE_ERROR"))'/>
                    </xsl:variable>
              ...
              <xsl:value-of select="/inp1:CustomProcessPO/ProcessPO/DataArea/imp1:PurchaseOrder/imp1:PurchaseOrderHeader/imp1:ExtendedAmount"/>
                ...
                <!--  <xsl:if test="imp1:PurchaseOrderHeader/imp1:ExtendedAmount/@currencyID !=''">-->
                    <xsl:attribute name="currencyID">
                      <xsl:value-of select="orcl:lookup-dvm('Currencies','CODE',imp1:PurchaseOrderHeader/imp1:ExtendedAmount/@currencyID,'Target',concat(imp1:PurchaseOrderHeader/imp1:ExtendedAmount/@currencyID,&quot;COMPLIANCE_ERROR&quot;))"/>
                    </xsl:attribute>                    
                  <!--</xsl:if>-->
                  <!-- Added on 12 NOV -->
                  <!--
                ...
                <imp1:PaymentTerm>
                  <imp1:Term>
                    ...
                    <xsl:variable name="PaymentTerm_Var">
                  ...
                  <imp1:Location>
                    ...
                    <xsl:value-of select="/inp1:CustomProcessPO/ProcessPO/DataArea/imp1:PurchaseOrder/imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode"/>
                      ...
                      <xsl:if test="imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode !=''">
                        <imp1:CountryCode>
                          <xsl:value-of select="orcl:lookup-dvm('Countries','Country Code',imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode,'Target',concat(imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode,&quot;COMPLIANCE_ERROR&quot;))"/>
                        </imp1:CountryCode>
                      </xsl:if>
                      <xsl:if test="imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode =''">
                        <imp1:CountryCode>
                        ...
                        <imp1:Codes>
                          ...
                          <xsl:if test="imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2] !=''">
                            <imp1:Code>
                              ...
                              <xsl:value-of select="orcl:lookup-dvm('DRI Code Values','DRI Code',imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2],'Target',concat(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2],&quot;COMPLIANCE_ERROR&quot;))"/>
                            </imp1:Code>
                          </xsl:if>
                          <xsl:if test="imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2] =''">
                            <imp1:Code>
                          ...
                          <xsl:if test='imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode !=""'>
                            <imp1:NameValue>
                              ...
                              <xsl:choose>
                                  ...
                                  <xsl:otherwise>
                                      <xsl:attribute name="unitCode">
                                        <xsl:value-of select="orcl:lookup-dvm('UnitOfMeasure','UOM',imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode,'Target',concat(imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode,&quot;COMPLIANCE_ERROR&quot;))"/>
                                      </xsl:attribute>
                                  </xsl:otherwise>
                              </xsl:choose>
                ...
                <xsl:value-of select="imp1:Quantity"/>
                  ...
                  <imp1:Quantity>
                    <!--<xsl:if test="imp1:Quantity/@unitCode !=''">-->
                      <xsl:attribute name="unitCode">
                        <xsl:value-of select="orcl:lookup-dvm('UnitOfMeasure','UOM',imp1:Quantity/@unitCode,'Target',concat(imp1:Quantity/@unitCode,&quot;COMPLIANCE_ERROR&quot;))"/>
                      </xsl:attribute>
                      <!--
                    </xsl:if>
                    <xsl:if test="imp1:Quantity/@unitCode =''">
