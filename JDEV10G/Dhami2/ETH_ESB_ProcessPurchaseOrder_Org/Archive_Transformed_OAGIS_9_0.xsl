...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED APR 01 21:29:49 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns6 ns2 ns0 ns1 ns7 ns9 inp1 ns5 ns8 ns3 ns4 plt jca imp1 tns hdr ehdr xp20 ora orcl bpws hwf xref ids">
  <xsl:template match="/">
    <imp1:RootElement>
      <ScMasterTransaction>
        <Message_ID>
        ...
        <stage>
          <xsl:value-of select='string("Transformed")'/>
        </stage>
        <senderXmlDocumentNumber>
        ...
        <receiverName>
          <xsl:value-of select="/inp1:CustomProcessPO/ProcessPO/DataArea/ns4:PurchaseOrder/ns4:PurchaseOrderHeader/ns4:SupplierParty/ns4:Name"/>
        </receiverName>
        <attribute2>
      ...
      <scDetailedTransaction>
        ...
        <transactionType>
          <xsl:value-of select='string("ProcessPO_9_0")'/>
        </transactionType>
        <payload>
        ...
        <source>
          <xsl:value-of select='string("ETH")'/>
        </source>
      </scDetailedTransaction>
    </imp1:RootElement>
  </xsl:template>
