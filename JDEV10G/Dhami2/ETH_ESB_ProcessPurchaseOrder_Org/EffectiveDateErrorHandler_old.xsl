...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED MAR 04 13:28:43 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl inp1 ns5 ns4 ns7 ns1 ns0 ns2 tns ns3 ns6 ns8 plnk soap ns9 ns10 bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
    <ns9:CommonErrorHandlingProcessRequest>
      <ns9:input>
        <ns10:CommonErrorHandler>
          ...
          <ns10:message>
            <xsl:value-of select='string("The trading Partner is not currently enabled.")'/>
          </ns10:message>
          <ns10:exception>
