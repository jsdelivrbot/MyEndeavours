...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED APR 15 16:21:34 IST 2009]. -->
?>
  ...
  <xsl:template match="/">
    <imp1:CommonErrorHandlerCollection>
      <imp1:CommonErrorHandler>
        ...
        <imp1:message>
          <xsl:value-of select='string("Routing has failed. Confirm that Sender ID, Receiver ID, and Receiver Site ID (if applicable) are set correctly in the transaction and the Routing Table")'/>
        </imp1:message>
        <imp1:exception>
