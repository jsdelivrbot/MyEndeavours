...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED MAR 18 20:21:36 IST 2009]. -->
?>
  ...
  <xsl:template match="/">
    <imp1:RootElement>
      <ScMasterTransaction>
        ...
        <xsl:choose>
          <xsl:when test='contains(orcl:get-content-as-string(/inp1:CustomProcessPO/ProcessPO),"COMPLIANCE_ERROR") = true()'>
            <dataCompliant>
        ...
        <stage>
          <xsl:value-of select='string("Compliance_Checked")'/>
        </stage>
        <receiverGroup>
