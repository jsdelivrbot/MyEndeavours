...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE OCT 06 10:56:52 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns0 xs nxsd tns bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
    <tns:Root-Element>
