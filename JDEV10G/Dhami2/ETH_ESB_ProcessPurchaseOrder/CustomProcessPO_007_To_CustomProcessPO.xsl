...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED FEB 25 13:33:36 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns1 ns0 inp1 tns ns2 ns7 ns9 ns6 ns3 ns4 imp1 ns8 ns10 bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
    <ns2:CustomProcessPO>
     <ProcessPO>
      ...
      <imp1:ApplicationArea>
        <imp1:Sender>
          <imp1:LogicalID>
            ...
            <xsl:value-of select="/ns1:CustomProcess_PO_007/Party_site_id"/>            
          </imp1:LogicalID>
          <imp1:ComponentID>
...
<!--START FOR THE PARTNER USERAREA -->     <!-- DONE ON 13 OCT -->
          ...
          <xsl:choose>
            ...
            <xsl:sort select="inp1:POLINENUM" data-type="number"/>
...
<!--START FOR THE DFFLINE OF USERAREA -->
            ...
            <xsl:variable name="Requestor_temp_sub_ln">  <!--added on 18 MAR-->                                          
            <xsl:value-of select='substring-after($temp_ln,"REQUESTOR>")'/>                       
              </xsl:variable>                                                                        
            <xsl:variable name="Requestor_temp_ln">                                               
              <xsl:value-of select='substring-before($Requestor_temp_sub_ln,"&lt;/REQUESTOR")'/>
            </xsl:variable> 
            <!--START FOR THE DFFLINE OF USERAREA -->
           ...
           <imp1:UserArea>
                <xsl:if test="$sch_year != ''">
                 ...
                 <imp1:BuyerContact> <!--Added on 18 MAR-->
                  <imp1:Name>
                    <xsl:value-of select="$Requestor_temp_ln"/>
                  </imp1:Name>
                  <imp1:JobTitle> 
