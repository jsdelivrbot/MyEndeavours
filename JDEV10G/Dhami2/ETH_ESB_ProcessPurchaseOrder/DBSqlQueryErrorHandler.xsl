...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED APR 15 16:22:11 IST 2009]. -->
?>
    ...
    <imp1:CommonErrorHandlerCollection>
      <imp1:CommonErrorHandler>
        ...
        <imp1:invokedOperationName>
          <xsl:value-of select='string("SqlError")'/>
        </imp1:invokedOperationName>
        <imp1:flowId>
          <xsl:value-of select="/inp1:CustomProcessPO/Flow_id_2"/>
        </imp1:flowId>
        <imp1:message>
          <xsl:value-of select='string("PL SQL Error : The procedure has thrown an unexpected error")'/>
        </imp1:message>
        <imp1:exception>
          <xsl:value-of select='string("PL SQL Exception")'/>
        </imp1:exception>
        <imp1:inPayload>
