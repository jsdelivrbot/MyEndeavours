...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE FEB 17 19:35:17 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl imp1 inp1 ns5 ns7 ns4 ns1 ns0 ns2 tns ns3 ns6 ns8 bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
        ...
        <xsl:for-each select="/inp1:CustomProcessPO/ProcessPO/DataArea/imp1:PurchaseOrder">
          <imp1:PurchaseOrder>
            <imp1:PurchaseOrderHeader>
              <imp1:DocumentID>
                <!--Substring-before added -->
                <xsl:choose>
                  <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:DocumentID/imp1:ID,"COMPLIANCE_ERROR") = true()'>
                    <imp1:ID>
                      <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:DocumentID/imp1:ID,"COMPLIANCE_ERROR")'/>
                    </imp1:ID>
                  </xsl:when>
                  <xsl:otherwise>
                    <imp1:ID>
              ...
              <imp1:Description>    <!-- Added as on 26 NOV -->
            ...
            <xsl:for-each select="imp1:PurchaseOrderHeader/imp1:Note">
              ...
              <imp1:Note>
                ...
                <imp1:PartyIDs>
                  <xsl:choose>
                    <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:PartyIDs/imp1:ID,"COMPLIANCE_ERROR") = true()'>
                      <imp1:ID>
                        <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:PartyIDs/imp1:ID,"COMPLIANCE_ERROR")'/>
                      </imp1:ID>
                    </xsl:when>
                    <xsl:otherwise>
                      <imp1:ID>
                ...
                <!-- DVM Lookup Updated : 22 Mar -->
                  <xsl:choose>
                    <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Name,"COMPLIANCE_ERROR") = true()'>
                      <imp1:Name>
                        <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Name,"COMPLIANCE_ERROR")'/>
                     </imp1:Name>
                    </xsl:when>
                    <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Name,"COMPLIANCE_EXCEPTION") = true()'>
                      <imp1:Name>
                        <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Name,"COMPLIANCE_EXCEPTION")'/>
                     </imp1:Name>
                    </xsl:when>
                    <xsl:otherwise>
                      <imp1:Name>
                ...
                <imp1:Location>
                  ...
                  <imp1:Address>
                    ...
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountrySubDivisionCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountrySubDivisionCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountrySubDivisionCode>
                    ...
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountryCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:SupplierParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountryCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountryCode>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'"><!--8 DEC-->
                  <imp1:Description>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'"><!-- Added as on 8 DEC-->
                <imp1:Contact>
                  <imp1:Communication>
                    <imp1:ChannelCode>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'"><!--8 DEC-->
                <imp1:AlternateDocumentID>
                      <imp1:ID>
                  <xsl:value-of select="imp1:PurchaseOrderHeader/imp1:ContractReference/imp1:AlternateDocumentID"/>
                      </imp1:ID>
                </imp1:AlternateDocumentID>
</xsl:if><!--8 DEC-->
              ...
              <imp1:ExtendedAmount>
                <xsl:choose>
                  <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:ExtendedAmount/@currencyID,"COMPLIANCE_ERROR") = true()'>
                    <xsl:attribute name="currencyID">
                      <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:ExtendedAmount/@currencyID,"COMPLIANCE_ERROR")'/>
                    </xsl:attribute>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:attribute name="currencyID">
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'"><!--8 DEC-->
                ...
                <imp1:Location>
                  ...
                  <imp1:Address>
                    ...
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:BillToParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountrySubDivisionCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:BillToParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountrySubDivisionCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountrySubDivisionCode>
                    ...
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:BillToParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountryCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:BillToParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountryCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountryCode>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'">
                ...
                <xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID ='LIEBERTNA'">
                  ...
                  <imp1:Name>
                    <xsl:value-of select="imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:PlaceOfOwnershipTransferLocation"/>
                    </imp1:Name>
                  </imp1:PlaceOfOwnershipTransferLocation>
                </xsl:if>
                ...
                <!--Substring-before added -->
                <xsl:choose>
                  <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode,"COMPLIANCE_ERROR") = true()'>
                    <imp1:FreightTermCode>
                      <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode,"COMPLIANCE_ERROR")'/>
                    </imp1:FreightTermCode>
                  </xsl:when>
                  <xsl:otherwise>
                    <imp1:FreightTermCode>
                ...
                <!--   <imp1:UserArea>
                <imp1:Note>
                  <xsl:value-of select="imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:UserArea/imp1:Note"/>
                </imp1:Note>
              </imp1:UserArea> -->
        <xsl:if test="(/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA') and ((imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:IncotermsCode !='') or (imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode !=''))">  
              <imp1:UserArea>
              <imp1:Note>
                 <xsl:attribute name="author">
              ...
              <imp1:PaymentTerm>
                <imp1:Term>
                  ...
                  <!--Substring-before added -->
                  <xsl:choose>
                    <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:PaymentTerm/imp1:Term/imp1:ID,"COMPLIANCE_ERROR") = true()'>
                      <imp1:ID>
                        <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:PaymentTerm/imp1:Term/imp1:ID,"COMPLIANCE_ERROR")'/>
                      </imp1:ID>
                    </xsl:when>
                    <xsl:otherwise>
                      <imp1:ID>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'">
                ...
                <imp1:Location>
                  ...
                  <imp1:Address>
                    ...
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountrySubDivisionCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountrySubDivisionCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountrySubDivisionCode>
                    ...
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR") = true()'>
                        <imp1:CountryCode>
                          <xsl:value-of select='substring-before(imp1:PurchaseOrderHeader/imp1:BuyerParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR")'/>
                        </imp1:CountryCode>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:CountryCode>
...
<xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID !='LIEBERTNA'">
                ...
                <imp1:Classification>
                  <imp1:Codes>  
                  <xsl:if test="(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1] !='') and (contains(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1],'COMPLIANCE_ERROR') = true())">
                    <imp1:Code>
                  ...
                  <xsl:attribute name="sequence">
                    <xsl:value-of select="string('1')"/>
                      ...
                      <xsl:value-of select='substring-before(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1],"COMPLIANCE_ERROR")'/>
                     </imp1:Code>
                     </xsl:if>
                 <xsl:if test="(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1] ='') or (contains(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1],'COMPLIANCE_ERROR') != true())">
                  <imp1:Code>
                  <xsl:attribute name="name">
                    <xsl:value-of select="string('HTS Code')"/>
                  </xsl:attribute>
                 ...
                 <xsl:if test="(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2] !='') and (contains(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2],'COMPLIANCE_ERROR') = true())">
                    <imp1:Code>
                     <xsl:attribute name="name">
                  ...
                  <xsl:attribute name="sequence">
                    <xsl:value-of select="string('2')"/>
                      ...
                      <xsl:value-of select='substring-before(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2],"COMPLIANCE_ERROR")'/>
                     </imp1:Code>
                     </xsl:if>
                 <xsl:if test="(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2] ='') or (contains(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2],'COMPLIANCE_ERROR') != true())">
                  <imp1:Code>
                  <xsl:attribute name="name">
                    <xsl:value-of select="string('Emerson Commodity Code')"/>
                  </xsl:attribute>
             ...
             <!--Changed the following Specification mapppings on 8 dec -->
              <xsl:if test="/inp1:CustomProcessPO/ProcessPO/imp1:ApplicationArea/imp1:Sender/imp1:LogicalID ='LIEBERTNA'">
                <imp1:Specification>
                  ...
                  <xsl:if test='imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode !=""'>
                    <imp1:NameValue>
                      ...
                      <!-- DVM Lookup Updated : 22 Mar -->
                      <xsl:choose>
                      <xsl:when test='contains(imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode,"COMPLIANCE_ERROR") = true()'>
                        <xsl:attribute name="unitCode">
                            <xsl:value-of select='substring-before(imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode,"COMPLIANCE_ERROR")'/>
                        </xsl:attribute>
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:attribute name="unitCode">
                    ...
                    </xsl:if><!--Added if condition on 12 Nov -->
                     <xsl:if test='imp1:Item/imp1:Specification/imp1:Property/imp1:NameValue/@unitCode =""'>
                    <imp1:NameValue>  
                      <!--LookUp Added if condition on 12 Nov -->
                      <xsl:attribute name="name">
                  ...
                  <imp1:HazardousMaterial>
                    <!--Substring-before added -->
                    <xsl:choose>
                      <xsl:when test='contains(imp1:Item/imp1:HazardousMaterial/imp1:ID,"COMPLIANCE_ERROR") = true()'>
                        <imp1:ID>
                          <xsl:value-of select='substring-before(imp1:Item/imp1:HazardousMaterial/imp1:ID,"COMPLIANCE_ERROR")'/>
                        </imp1:ID>
                      </xsl:when>
                      <xsl:otherwise>
                        <imp1:ID>
                ...
                <imp1:Quantity>
                  <!--Substring-before added -->
                  <xsl:choose>
                    <xsl:when test='contains(imp1:Quantity/@unitCode,"COMPLIANCE_ERROR") = true()'>
                      <xsl:attribute name="unitCode">
                        <xsl:value-of select='substring-before(imp1:Quantity/@unitCode,"COMPLIANCE_ERROR")'/>
                      </xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="unitCode">
					...
					<xsl:if test="imp1:UserArea/imp1:RequestedShipDateTime !=''">
                     ...
                     <xsl:if test="imp1:UserArea/imp1:BuyerContact/imp1:Name !=''">
                      ...
                      <imp1:ShipToParty>
                        ...
                        <!-- DVM Lookup Updated : 22 Mar -->
                        <xsl:choose>
                          <xsl:when test='contains(imp1:UserArea/imp1:ShipToParty/imp1:Name,"COMPLIANCE_ERROR") = true()'>
                            <imp1:Name>
                                <xsl:value-of select='substring-before(imp1:UserArea/imp1:ShipToParty/imp1:Name,"COMPLIANCE_ERROR")'/>
                            </imp1:Name>
                          </xsl:when>
                          <xsl:when test='contains(imp1:UserArea/imp1:ShipToParty/imp1:Name,"COMPLIANCE_EXCEPTION") = true()'>
                            <imp1:Name>
                                <xsl:value-of select='substring-before(imp1:UserArea/imp1:ShipToParty/imp1:Name,"COMPLIANCE_EXCEPTION")'/>
                            </imp1:Name>
                          </xsl:when>
                          <xsl:otherwise>
                            <imp1:Name>
                    ...
                    <!--
                        ...
                        <imp1:Location>
                          ...
                          <imp1:Address>
                            ...
                            <!--Substring-before added -->
                            <xsl:choose>
                              <xsl:when test='contains(imp1:UserArea/imp1:ShipToParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR") = true()'>
                                <imp1:CountrySubDivisionCode>
                                  <xsl:value-of select='substring-before(imp1:UserArea/imp1:ShipToParty/imp1:Location/imp1:Address/imp1:CountrySubDivisionCode,"COMPLIANCE_ERROR")'/>
                                </imp1:CountrySubDivisionCode>
                              </xsl:when>
                              <xsl:otherwise>
                                <imp1:CountrySubDivisionCode>
                            ...
                            <!--Substring-before added -->
                            <xsl:choose>
                              <xsl:when test='contains(imp1:UserArea/imp1:ShipToParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR") = true()'>
                                <imp1:CountryCode>
                                  <xsl:value-of select='substring-before(imp1:UserArea/imp1:ShipToParty/imp1:Location/imp1:Address/imp1:CountryCode,"COMPLIANCE_ERROR")'/>
                                </imp1:CountryCode>
                              </xsl:when>
                              <xsl:otherwise>
                                <imp1:CountryCode>
