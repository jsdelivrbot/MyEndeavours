...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE FEB 17 20:21:03 IST 2009]. -->
?>
  ...
  <xsl:template match="/">
    ...
    <!--  <ns9:Segment-ISA> -->
      ...
      <xsl:variable name="SC_SeqNo">  
        <xsl:value-of select="orcl:sequence-next-val('SC_Control_Num_Seq','jdbc:polite4:system/any@localhost:1531:OraESB')"/>
      </xsl:variable>  
      <ns9:Segment-ST>      
        <ns9:Element-143>
   ...
   <!--<ns9:Loop-LDT>
      ...
      <xsl:for-each select="imp1:PurchaseOrderHeader/imp1:SupplierParty">
        <ns9:Loop-N1>
         ...
         <xsl:if test="$LENGTH_VN > 60.0">   <!-- ADDED AS ON 8 OCT-->
          ...
          <xsl:for-each select="imp1:Location/imp1:Address">
            <ns9:Segment-N3>
              <ns9:Element-166>
                <xsl:value-of select="imp1:LineOne"/>
              </ns9:Element-166>
              <ns9:Element-166_1>
                <xsl:value-of select="imp1:LineTwo"/>
              </ns9:Element-166_1>
            </ns9:Segment-N3>
          </xsl:for-each>
          <!--ADDED AS ON 16 OCT -->
        <xsl:for-each select="imp1:Location/imp1:Address">
            <xsl:if test='(imp1:LineThree!="") or (imp1:LineFour != "")'>
              <ns9:Segment-N3>
                <ns9:Element-166>
                  <xsl:value-of select="imp1:LineThree"/>
                </ns9:Element-166>
                <ns9:Element-166_1>
                  <xsl:value-of select="imp1:LineFour"/>
                </ns9:Element-166_1>
              </ns9:Segment-N3>
            </xsl:if>
          </xsl:for-each>
        ...
        <xsl:if test='concat(@category,"BuyerParty")'>
          <ns9:Loop-N1>
            ...
            <ns9:Segment-N4>
              ...
              <xsl:if test='imp1:Location/imp1:Address/imp1:CountryCode = ("US" or "CA")'>
                <ns9:Element-156>
                  <xsl:value-of select="imp1:Location/imp1:Address/imp1:CountrySubDivisionCode"/>
                </ns9:Element-156>
              </xsl:if>
        ...
        <xsl:for-each select="/inp1:CustomProcessPO/ProcessPO/DataArea/imp1:PurchaseOrder/imp1:PurchaseOrderLine">
          <ns9:Segment-PO1>
            ...
            <ns9:Element-355_1>
              ...
              <xsl:value-of select='orcl:lookup-dvm("UnitOfMeasure","Target",imp1:Quantity/@unitCode,"EDI",concat(imp1:Quantity/@unitCode,&quot;Default&quot;))'/>
            </ns9:Element-355_1>
            <!-- <ns9:Element-355_1>
     ...
     <!--   <xsl:if test='(imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[1] != "") and (imp1:Item/imp1:Classification/imp1:Codes/imp1:Code[2] != "")'>
      ...
      <xsl:variable name="LENGTH_ST">  
          ...
          <!--ADDED AS ON 16 OCT -->
                  <xsl:for-each select="imp1:UserArea/imp1:ShipToParty/imp1:Location/imp1:Address">
            <xsl:if test='(imp1:LineThree!="") or (imp1:LineFour != "")'>
              <ns9:Segment-N3>
                <ns9:Element-166>
                  <xsl:value-of select="imp1:LineThree"/>
        ...
        <xsl:if test='((imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Name !="") or (imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[3]/imp1:DialNumber != "") or (imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[2]/imp1:DialNumber !="") or (imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[1]/imp1:URI != ""))'> 
        <ns9:Segment-PER>
            <ns9:Element-366>
              <xsl:value-of select='string("BD")'/>
            </ns9:Element-366>
            <xsl:if test='imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Name !=""'>
            <ns9:Element-93>
              <xsl:value-of select="imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Name"/>
            </ns9:Element-93>
            </xsl:if>
            
            <xsl:if test="imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[3]/imp1:DialNumber != ''"> 
            <ns9:Element-365>
              <xsl:value-of select='string("TE")'/>
            </ns9:Element-365>
            <ns9:Element-364>
            ...
            <xsl:if test="imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[2]/imp1:DialNumber !='' ">
            <ns9:Element-365_1>
              <xsl:value-of select='string("FX")'/>
            </ns9:Element-365_1>
            <ns9:Element-364_1>
            ...
            <xsl:if test='imp1:UserArea/imp1:ShipToParty/imp1:Contact/imp1:Communication[1]/imp1:URI != ""'>
            <ns9:Element-365_2>
              <xsl:value-of select='string("EM")'/>
            </ns9:Element-365_2>
            <ns9:Element-364_2>
