...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [WED APR 15 16:21:53 IST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns6 ns2 ns0 ns1 ns7 ns9 inp1 ns5 ns8 ns3 ns4 tns plt jca imp1 hdr ehdr xp20 ora orcl bpws hwf sample xref ids">
  <xsl:template match="/">
    <imp1:CommonErrorHandlerCollection>
      <imp1:CommonErrorHandler>
        ...
        <imp1:message>
          <xsl:value-of select='string("Data Compliance Check Failure : Input Data (source system) must be updated.")'/>
        </imp1:message>
        <imp1:exception>
