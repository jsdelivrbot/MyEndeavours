...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="LBT_FtpPut_OperatingUnit.wsdl"/>
      <rootElement name="Root-Element" namespace="http://TargetNamespace.com/FtpOpertngUnit_to_Vendavo"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED SEP 10 12:19:19 IST 2008]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns5 ns7 ns4 ns2 ns0 ns3 ns1 inp1 ns6 ns8 imp1 tns plt jca hdr bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
    <imp1:Root-Element>
