...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="VDST_JMSQDEQ_CatalogPricingCTE.wsdl"/>
      <rootElement name="envelope" namespace="http://schemas.emerson.com/common/envelope"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
      <schema location="VDST_JMSQENQ_CSV_CatalaogPricing.wsdl"/>
      <rootElement name="envelope" namespace="http://schemas.emerson.com/common/envelope"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE JUN 30 19:25:27 GMT+05:30 2009]. -->
?>
<xsl:stylesheet version="1.0"
                xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                xmlns:plt="http://schemas.xmlsoap.org/ws/2003/05/partner-link/"
                xmlns:pc="http://xmlns.oracle.com/pcbpel/"
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/jms/VDST_JMSQDEQ_CatalogPricingCTE/"
                xmlns:ehdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.esb.server.headers.ESBHeaderFunctions"
                xmlns:ns0="http://www.w3.org/2001/XMLSchema"
                xmlns:jca="http://xmlns.oracle.com/pcbpel/wsdl/jca/"
                xmlns:ns1="http://xmlns.oracle.com/pcbpel/adapter/jms/VDST_JMSQENQ_CSV_CatalaogPricing/"
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="ExecutionUnitName" select="string('VDST_ESB_CatalogPricingEBS')"/>
