...
public class UserWebServicePortType_findUser_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    public UserWebServicePortType_findUser_Fault_SOAPSerializer(boolean encodeType, boolean isNullable, SOAPVersion soapVersion) {
