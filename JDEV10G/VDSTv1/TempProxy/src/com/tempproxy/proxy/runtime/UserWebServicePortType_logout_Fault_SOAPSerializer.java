...
public class UserWebServicePortType_logout_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    private static final int com_tempproxy_proxy_types_com_emerson_service_vdst_tool_common_SOAPException_INDEX = 0;
    private static final int com_tempproxy_proxy_types_com_emerson_service_vdst_tool_common_FaultDetailType_INDEX = 1;
    
    public UserWebServicePortType_logout_Fault_SOAPSerializer(boolean encodeType, boolean isNullable, SOAPVersion soapVersion) {
