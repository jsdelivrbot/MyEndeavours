...
public class LoginRequestType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    public LoginRequestType_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public LoginRequestType_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.tempproxy.proxy.LoginRequestType instance = new com.tempproxy.proxy.LoginRequestType();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_Password_QNAME))) {
                ...
                member = myns2_base64Binary__byte_Base64Binary_Serializer.deserialize(ns1_Password_QNAME, reader, context);
                requiredElements.remove("Password");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPassword((byte[])member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.tempproxy.proxy.LoginRequestType instance = (com.tempproxy.proxy.LoginRequestType)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2_base64Binary__byte_Base64Binary_Serializer.setNullable( false );
        myns2_base64Binary__byte_Base64Binary_Serializer.serialize(instance.getPassword(), ns1_Password_QNAME, null, writer, context);
    }
}
