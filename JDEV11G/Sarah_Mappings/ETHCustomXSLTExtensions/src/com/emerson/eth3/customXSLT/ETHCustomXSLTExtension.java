package com.emerson.eth3.customXSLT;
 ...
 * @version 3.1
 */
public class ETHCustomXSLTExtension {
  private static boolean logFlag = false;

  public ETHCustomXSLTExtension() {
    super();
  }
  ...
  public static String getISODateFromEDI(String editDate, String ediTime,
    ...
    try {
      ...
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][getISODateFromEDI] - "+e.getMessage());
    }
  ...
  public static String getEDIDate(String canonicalDateTime,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][getEDIDate] - "+e.getMessage());
    }
 ...
 /*
  ...
  public static String split(String inputString, String splitCharacter,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][split] - "+e.getMessage());
    }
    track =
  ...
  public static String ethParameterLookup(String dataSourceJNDI,
                                          String jdbcURL,
    ...
    String result = defaultResponse;
    String track =
      "StartXSLT:ethParameterLookup[" + dataSourceJNDI + "," + jdbcURL + "," +
    ...
    try {
      ...
      cs =
          connection.prepareCall("{call ETH_CUSTOM_SCHEMA.ETH_GET_PARAMETERVALUES_PKG.ETH_GET_PARAMETERVALUES_PRC(?,?,?,?,?,?,?,?)}");
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][ethParameterLookup] - "+e.getMessage());
    } finally {
      try {
        if (cs != null) {
          cs.close();
    ...
    track =
        track + ":ENDXSLT:ethParameterLookup[" + dataSourceJNDI + "," + jdbcURL +
  ...
  public static int lengthCheck(String input, int minLength, int maxlength,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][lengthCheck] - "+e.getMessage());
    }
  ...
  public static String formatValue(String inputValue, int minLength,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][formatValue] - "+e.getMessage());
    }
  ...
  public static String truncate(String inputValue, int truncateLength, String defaultResponse){
    ...
    try{
      ...
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][truncate] - "+e.getMessage());
      result = defaultResponse;
    }
    return result;
  }
  ...
  public static String formatAmount(String inputLongString, String decimalPointString, String sign, String defaultResponse) {
    ...
    try{
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][formatAmount] - "+e.getMessage());
    }
  ...
  private static Connection getConnection(){
    ...
    properties.put(Context.SECURITY_CREDENTIALS, "!Inder123!");
    Connection conn = null;

    try {
      ctx = new InitialContext(properties);
      Object dataSourceObject = ctx.lookup("jdbc/ETH/AppDB_DS_NXA");
      ...
      System.out.println("[ETHCustomXSLTExtension][EXCEPTION][getConnection] - "+e.getMessage());
...
//    //String result = ethParameterLookup("","jdbc:oracle:thin:@usmtnz-sscmdb06.stage.emrsn.org:24001:eth3s0 SOAMAPPINGUSER SOAMAPPINGUSER","false", "DarkKnight", "Testing", "BASISOFUNITPRICE", "PE", "PE");
//    //String result = ethParameterLookup("","jdbc:oracle:thin:@orionddb.emerson.com:34002:oriond2 eth_custom_schema eth_custom_schema","false", "DarkKnight", "Testing", "BASISOFUNITPRICE", "PE", "PE");
//    //String result = formatValue("USDS", 3, 4, 1,"ZZZ", "Not");
//    //String result = split("Inco2010:EXW:Houston", ":", 4, "ERROR");
//    //String result = getEDIDate("2011-03-03T11:02:59.0000+00:00","ZZZZ");
//    //String result = getISODateFromEDI("20110722", "NO_TIME", null, "20110722");
//    //String result = truncate("Hello Sir Ji",50,"Hello Sir Ji");
//    String result = formatAmount("0", "1", "-", "420200");
//    
//   System.out.println("Result Final - " + result);
//    
//    
//   /*String purchaseOrderId = "501P00150474 ";    
//   String operatingUnitNumber = "LIEBERTNA";  
//      
//   String releaseNumber = "";    
//   String revisionNumber = "0000000 ";   
//      
...
//   }     
//     
//   if(revisionNumber==null || "".equalsIgnoreCase(revisionNumber)){   
//     revisionNumber = "0";      
//   }   
//   else{   
...
//   } 
//   else if(operatingUnitNumber.length()>10){ 
...
//     
//   System.out.println("KEY - "+purchaseOrderId+":"+releaseNumber+":"+revisionNumber+":"+operatingUnitNumber);
//  */
//  }
