package com.emerson.ecth.customSOA;
 ...
 * @version 1.0
 */
public class ECTHCustomSOAExtension {
  ...
  final static String FILENAME_PREFIX = "ECTH_";
  final static int FILENAME_MAX_LENGTH = 100;
  
  public ECTHCustomSOAExtension() {
    super();
  }

  /**
   * This Function is used to evaluate ECTH DB Procedure response. 
...

  {
    ...
    try{
      ...
      System.out.println("[ECTHCustomSOAExtension][EXCEPTION][evaluateDBResponse] - "+e.getMessage());
      return JAVA_FAILURE;
    }
    finally{
   ...
   * If NULL or "" or whitespaces are passed as file name, it will return back a random type 4 UUID prefixed with string 'ECTH_'.
  ...
  public static String validateFileName(String fileName){
    ...
    try{
      ...
      System.out.println("[ECTHCustomSOAExtension][EXCEPTION][validateFileName] - "+e.getMessage());
    }
    finally{
      fileName = null;
    }
