...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="../ETH_FL_WR_POCO_OAGIS.wsdl"/>
      <rootElement name="ChangePurchaseOrder" namespace="http://www.openapplications.org/oagis/9"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [MON MAY 30 14:36:46 GMT+05:30 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns14="http://xmlns.oracle.com/pcbpel/adapter/file/Sarah_Mappings/ETH_Sarah_ConnectorService/ETH_FL_WR_POCO_OAGIS"
                ...
                exclude-result-prefixes="xsi xsl ns3 pc ns6 imp1 plt ns7 wsdl ns8 ns9 ns11 ns0 ns1 ns2 ns4 jca ns5 tns xsd ns10 ns12 ns13 ns14 aia bpws xp20 bpel bpm ora socket mhdr oraext ethCustomXSLT dvm hwf med ids xdk xref bpmn ldap">
  <xsl:template match="/">
    <ns9:ChangePurchaseOrder>
      <xsl:attribute name="releaseID">
        <xsl:value-of select="string('9.0')"/>
      </xsl:attribute>
      <ns9:ApplicationArea>
        <xsl:copy-of select="/imp1:UpdatePurchaseOrderEBM/ns10:EBMHeader/ns10:Custom/ns9:ApplicationArea/*"/>
      </ns9:ApplicationArea>
      <ns9:DataArea>
        <ns9:Change>
          <xsl:attribute name="responseCode">
            <xsl:value-of select="/imp1:UpdatePurchaseOrderEBM/imp1:DataArea/ns10:Update/@responseCode"/>
          </xsl:attribute>
        </ns9:Change>
        <ns9:PurchaseOrder>
          <xsl:copy-of select="/imp1:UpdatePurchaseOrderEBM/imp1:DataArea/imp1:UpdatePurchaseOrder/*"/>
        </ns9:PurchaseOrder>
      </ns9:DataArea>
    </ns9:ChangePurchaseOrder>
  </xsl:template>
