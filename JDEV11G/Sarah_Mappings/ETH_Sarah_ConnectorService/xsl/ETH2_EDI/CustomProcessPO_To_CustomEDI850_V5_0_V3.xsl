...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.4.0(build 080718.0645) AT [TUE AUG 04 15:48:16 IST 2009]. -->
?>
   ...
   <xsl:if test="(imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode != '') or (imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:PlaceOfOwnershipTransferLocation/imp1:Name !='') "> 
      <ns9:Segment-FOB>
        <!-- 23 Jun 2009 - Fix for Issue 139a -->
          <xsl:choose>
            <xsl:when test="(imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode = 'UCC FOB ORIGIN PPD') or (imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode = 'UCC FOB DEST PPD')">
                <ns9:Element-146>       
                  <xsl:value-of select='string("PP")'/>
                </ns9:Element-146>
            </xsl:when>
            <xsl:when test="(imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode = 'UCC FOB ORIGIN COL') or (imp1:PurchaseOrderHeader/imp1:TransportationTerm/imp1:FreightTermCode = 'UCC FOB DEST COL')">
                <ns9:Element-146>       
        ...
        <!-- 23 Jun 2009 - Fix for Issue 139a -->
        <!-- 30 Sep 2009 - Updated to populate FOB03 from IncotermsCode instead of FreightTerm, as per new mapping -->
