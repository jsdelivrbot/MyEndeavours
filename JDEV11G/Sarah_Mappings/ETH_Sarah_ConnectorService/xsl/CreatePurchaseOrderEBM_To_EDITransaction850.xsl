...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [TUE JUN 14 11:58:03 GMT+05:30 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns15="http://schema.emerson.com/ETH/B2B/EDI/850/V5020"
                ...
                exclude-result-prefixes="xsi xsl ns3 pc ns6 ns7 plt imp1 ns11 ns9 ns8 wsdl tns ns0 ns2 ns1 ns4 jca ns5 xsd ns10 ns12 ns13 ns14 ns16 aia bpws xp20 ethCustomSOA bpel bpm ora socket mhdr oraext ethCustomXSLT dvm hwf med ids xdk xref bpmn ldap">
  <xsl:template match="/">
    <ns16:Transaction-850>
      ...
      <ns16:Segment-GS>
        ...
        <ns16:Element-142>
          <xsl:value-of select="/imp1:CreatePurchaseOrderEBM/ns10:EBMHeader/ns10:Custom/ns9:ApplicationArea/ns9:UserArea/ns9:CustomApplicationAreaUserArea/ns9:SenderID"/>
        </ns16:Element-142>
        <ns16:Element-455>
      ...
      <ns16:Segment-BEG>
        ...
        <ns16:Element-373>
          <xsl:value-of select="ethCustomXSLT:getEDIDate(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:DocumentDateTime,/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:DocumentDateTime)"/>
        </ns16:Element-373>
        <ns16:Element-587>
      ...
      <ns16:Segment-CUR>
        ...
        <xsl:if test='(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:UserArea/ns9:CustomPurchaseOrderHeaderUserArea/ns9:EXCHRATE != "") and (/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:UserArea/ns9:CustomPurchaseOrderHeaderUserArea/ns9:EXCHRATE != "0")'>
          <ns16:Element-280>
            <xsl:value-of select='ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:UserArea/ns9:CustomPurchaseOrderHeaderUserArea/ns9:EXCHRATE,4.0,10.0,0.0,"ZZZZ","XSLTERROR")'/>
          </ns16:Element-280>
          <!--<ns16:Element-374>
          ...
          <ns16:Element-373>
          <xsl:value-of select="ethCustomXSLT:getEDIDate(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:UserArea/ns9:CustomPurchaseOrderHeaderUserArea/ns9:ExchangeRateDate,'XSLTERROR')"/>
        </ns16:Element-373>
        </xsl:if>-->
        </xsl:if>
      </ns16:Segment-CUR>
      ...
      <!--<ns16:Loop-N1>
        <ns16:Segment-N1>
          ...
          <ns16:Element-93>
            <xsl:value-of select='ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Name[1],1.0,60.0,0.0,"Z","Not Populated by Source")'/>
          </ns16:Element-93>
          <ns16:Element-66>
        ...
        <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Name[2] != ''">
        <ns16:Segment-N2>  
            <ns16:Element-93>
              <xsl:value-of select='ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Name[2],1.0,60.0,0.0,"Z","ERROR")'/>
            </ns16:Element-93>
          <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Name[3] != ''">
          <ns16:Element-93_1>
            <xsl:value-of select='ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Name[3],1.0,60.0,0.0,"Z","ERROR")'/>
          </ns16:Element-93_1>
           </xsl:if>
        </ns16:Segment-N2>
        </xsl:if>
        ...
        <ns16:Segment-N4>
          ...
          <ns16:Element-116>
            <xsl:value-of select='ethCustomXSLT:split(ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:SupplierParty/ns9:Location/ns9:Address/ns9:PostalCode,3.0,15.0,0.0,"ZZZ","ZZZ"),"-",1,"ZZZ")'/>
          </ns16:Element-116>
          <ns16:Element-26>
      ...
      <!--<ns16:Loop-N1>
        <ns16:Segment-N1>
          ...
          <ns16:Element-93>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Name[1],1.0,60.0,0.0,'Z','Not Populated by Source')"/>
          </ns16:Element-93>
          <ns16:Element-66>
            <xsl:value-of select='string("93")'/>
          </ns16:Element-66>
        ...
        <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Name[2] != ''">
        <ns16:Segment-N2>
          <ns16:Element-93>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Name[2],1.0,60.0,0.0,'Z','ERROR')"/>
          </ns16:Element-93>
          <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Name[3] != ''">
          <ns16:Element-93_1>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Name[3],1.0,60.0,0.0,'Z','ERROR')"/>
          </ns16:Element-93_1>
          </xsl:if>
        </ns16:Segment-N2>
        </xsl:if>
        ...
        <ns16:Segment-N4>
          <ns16:Element-19>
              ...
              <ns16:Element-116>
                <xsl:value-of select='ethCustomXSLT:split(ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BillToParty/ns9:Location/ns9:Address/ns9:PostalCode,3.0,15.0,0.0,"ZZZ","ZZZ"),"-",1,"ZZZ")'/>
              </ns16:Element-116>
                <ns16:Element-26>
      ...
      <!--<ns16:Loop-N1>
        <ns16:Segment-N1>
          ...
          <ns16:Element-93>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Name[1],1.0,60.0,0.0,'Z','Not Populated by Source')"/>
          </ns16:Element-93>
          <ns16:Element-66>
            <xsl:value-of select='string("93")'/>
          </ns16:Element-66>
        ...
        <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Name[2] != ''">
        <ns16:Segment-N2>
          <ns16:Element-93>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Name[2],1.0,60.0,0.0,'Z','ERROR')"/>
          </ns16:Element-93>
          <xsl:if test="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Name[3] != ''">
          <ns16:Element-93_1>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Name[3],1.0,60.0,0.0,'Z','ERROR')"/>
          </ns16:Element-93_1>
          </xsl:if>
        </ns16:Segment-N2>
        </xsl:if>
        ...
        <ns16:Segment-N4>
          <ns16:Element-19>
              ...
              <ns16:Element-116>
                <xsl:value-of select='ethCustomXSLT:split(ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:BuyerParty/ns9:Location/ns9:Address/ns9:PostalCode,3.0,15.0,0.0,"ZZZ","ZZZ"),"-",1,"ZZZ")'/>
              </ns16:Element-116>
                <ns16:Element-26>
      ...
      <!--<ns16:Loop-N1>
        <ns16:Segment-N1>
          ...
          <ns16:Element-93>
            <xsl:value-of select="ethCustomXSLT:formatValue(/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderHeader/ns9:CarrierParty/ns9:Name[1],1.0,60.0,0.0,'ZZ','Not Populated by Source')"/>
          </ns16:Element-93>
          </ns16:Segment-N1>
          </ns16:Loop-N1>-->
      <xsl:for-each select="/imp1:CreatePurchaseOrderEBM/imp1:DataArea/imp1:CreatePurchaseOrder/ns9:PurchaseOrderLine">
        <ns16:Loop-PO1>
          <ns16:Segment-PO1>
            ...
            <ns16:Element-234_2>
              <xsl:value-of select='ethCustomXSLT:formatValue(ns9:Item/ns9:ItemID/ns9:RevisionID,1.0,48.0,0.0,"00","00")'/>
            </ns16:Element-234_2>
            <!-- </xsl:if>-->
          </ns16:Segment-PO1>
          ...
          <ns16:Segment-TD4>
            ...
            <ns16:Element-352>
              <xsl:value-of select='ethCustomXSLT:formatValue(ns9:Item/ns9:HazardousMaterial/ns9:ID,1.0,80.0,0.0,"","")'/>
            </ns16:Element-352>
          </ns16:Segment-TD4>
          <ns16:Segment-MTX>
            <ns16:Element-363>
          ...
          <ns16:Loop-N1>
            <ns16:Segment-N1>
              ...
              <ns16:Element-93>
                <xsl:value-of select='ethCustomXSLT:formatValue(ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Name[1],1.0,60.0,0.0,"Z","Not Populated by Source")'/>
              </ns16:Element-93>
              <ns16:Element-66>
                <xsl:value-of select='string("93")'/>
              </ns16:Element-66>
            ...
            <xsl:if test='ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Name[2] != ""'>
              <ns16:Segment-N2>
                <ns16:Element-93>
                  <xsl:value-of select='ethCustomXSLT:formatValue(ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Name[2],1.0,60.0,0.0,"Z","ERROR")'/>
                </ns16:Element-93>
                <xsl:if test='ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Name[3] != ""'>
                  <ns16:Element-93_1>
                    <xsl:value-of select='ethCustomXSLT:formatValue(ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Name[3],1.0,60.0,0.0,"Z","ERROR")'/>
                  </ns16:Element-93_1>
                </xsl:if>
              </ns16:Segment-N2>
            </xsl:if>
            ...
            <ns16:Segment-N4>
              ...
              <ns16:Element-116>
                <xsl:value-of select='ethCustomXSLT:split(ethCustomXSLT:formatValue(ns9:PurchaseOrderSchedule[1]/ns9:UserArea/ns9:CustomPurchaseOrderLineUserArea/ns9:CustomPurchaseOrderLineScheduleUserArea/ns9:ShipToParty/ns9:Location/ns9:Address/ns9:PostalCode,3.0,15.0,0.0,"ZZZ","ZZZ"),"-",1,"ZZZ")'/>
              </ns16:Element-116>
              <ns16:Element-26>
