...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="../OracleSCN.wsdl"/>
      <rootElement name="MoviesInCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/OracleSCN"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.0.0(build 090527.1400.5130) AT [FRI JUN 19 16:27:47 PDT 2009]. -->
?>
<xsl:stylesheet version="1.0"
                xmlns:xpath20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20"
                xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/AdaptersDB/ExpertPolling/OracleSCN%2F"
                ...
                xmlns:top="http://xmlns.oracle.com/pcbpel/adapter/db/top/OracleSCN"
                exclude-result-prefixes="xsi xsl tns plt xsd wsdl top ns0 ns1 xpath20 bpws mhdr oraext dvm hwf med ids xdk xref ora socket">
  <xsl:template match="/">
