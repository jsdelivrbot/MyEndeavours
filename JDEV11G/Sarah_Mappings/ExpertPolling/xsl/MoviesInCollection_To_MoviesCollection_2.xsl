...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="../SysdateLogicalDelete.wsdl"/>
      <rootElement name="MoviesInCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/SysdateLogicalDelete"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.0.0(build 090527.1400.5130) AT [FRI JUN 19 16:03:28 PDT 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/AdaptersDB/ExpertPolling/SysdateLogicalDelete%2F"
                xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue"
                xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath"
                xmlns:top="http://xmlns.oracle.com/pcbpel/adapter/db/top/SysdateLogicalDelete"
                ...
                exclude-result-prefixes="xsi xsl tns top plt xsd wsdl ns0 ns1 xpath20 bpws mhdr oraext dvm hwf med ids xdk xref ora socket">
  <xsl:template match="/">
