package com.emerson.epth.customXSLT;
 ...
 * @version 1.0
 */
public class EPTHCustomXSLTExtension {
  private static boolean logFlag = false;

  public EPTHCustomXSLTExtension() {
    super();
  }
  ...
  public static String getISODateFromEDI(String editDate, String ediTime,
    ...
    try {
      ...
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][getISODateFromEDI] - "+e.getMessage());
    }
  ...
  public static String getEDIDate(String canonicalDateTime,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][getEDIDate] - "+e.getMessage());
    }
 ...
 /*
  ...
  public static String split(String inputString, String splitCharacter,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][split] - "+e.getMessage());
    }
    track =
  ...
  public static String epthParameterLookup(String dataSourceJNDI,
                                          String jdbcURL,
    ...
    String result = defaultResponse;
    String track =
      "StartXSLT:epthParameterLookup[" + dataSourceJNDI + "," + jdbcURL + "," +
    ...
    try {
      ...
      cs =
          connection.prepareCall("{call EPTH_CUSTOM_SCHEMA.EPTH_GET_PARAMETERVALUES_PKG.EPTH_GET_PARAMETERVALUES_PRC(?,?,?,?,?,?,?,?)}");
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][epthParameterLookup] - "+e.getMessage());
    } finally {
      try {
        if (cs != null) {
          cs.close();
    ...
    track =
        track + ":ENDXSLT:epthParameterLookup[" + dataSourceJNDI + "," + jdbcURL +
  ...
  public static int lengthCheck(String input, int minLength, int maxlength,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][lengthCheck] - "+e.getMessage());
    }
  ...
  public static String formatValue(String inputValue, int minLength,
    ...
    try {
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][formatValue] - "+e.getMessage());
    }
  ...
  public static String truncate(String inputValue, int truncateLength, String defaultResponse){
    ...
    try{
      ...
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][truncate] - "+e.getMessage());
      result = defaultResponse;
    }
    return result;
  }
  ...
  public static String formatAmount(String inputLongString, String decimalPointString, String sign, String defaultResponse) {
    ...
    try{
      ...
      track = track + " | {ERROR=" + e.getMessage() + "}";
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][formatAmount] - "+e.getMessage());
    }
  ...
  private static Connection getConnection(){
    ...
    try {
      ...
      Object dataSourceObject = ctx.lookup("jdbc/EPTH/AppDB_DS_NXA");
      ...
      System.out.println("[EPTHCustomXSLTExtension][EXCEPTION][getConnection] - "+e.getMessage());
