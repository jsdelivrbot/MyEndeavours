        ...
        <corecom:Custom>
          ...
          <customEBMHeader:Sender>
              <customEBMHeader:LogicalID>
                <xsl:value-of select='normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5REF03)'/>
              ...
              <!-- Its "Interchange Date - Responsible Agency Code" -->
                <xsl:value-of select='concat(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDISA09),"-",normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDGS07))'/>
              </customEBMHeader:ReferenceID>
            ...
            <customEBMHeader:CreationDateTime>
              <xsl:value-of select="ethCustomXSLT:getISODateFromEDI(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDGS04),normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDGS05),'',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDGS04))"/>
            </customEBMHeader:CreationDateTime>
      ...
      <corecom:Change>
        ...
        <ebo:ChangePurchaseOrder>
          ...
          <ns9:PurchaseOrderHeader>
            <ns9:DocumentID>
              <ns9:ID>
                <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG03)"/>
              </ns9:ID>
              <ns9:RevisionID>
                ...
                <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1REF03)"/>
              </ns9:RevisionID>
              <xsl:variable name="variationID" select="normalize-space(/ns0:PurchaseOrder/ns0:Line/ns0:HDBEG02)"/>
              <xsl:choose>
            ...
            <xsl:if test="/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG05 and /ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG05 != ''">
              <!--<ns9:DocumentDateTime>
               ...
               <ns9:DocumentDateTime>
                <xsl:value-of select="ethCustomXSLT:getISODateFromEDI(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG05),'','',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG05))"/>
              </ns9:DocumentDateTime>
            </xsl:if>
            <ns9:Note>
                <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/HD1MTX02)"/>
            </ns9:Note>
            <ns9:Status>
                <ns9:Code>
            ...
            <xsl:if test='xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N101)) = "VN"'>
                <ns9:SupplierParty>
                  <ns9:PartyIDs>
                    <ns9:ID>
                      <!-- As discussed by Ryan on 4th Oct, 2011 -->
                      <xsl:value-of select='ethCustomXSLT:formatValue(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N104),2.0,80.0,0.0,$Default_N104,$Default_N104)'/>
                      <!--<xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N104)"/>-->
                    </ns9:ID>
                  </ns9:PartyIDs>
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N102))"/>
                  </ns9:Name>
                  <xsl:if test="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N201)) != ''">
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N201))"/>
                  </ns9:Name>
                  </xsl:if>
                   <!--<ns9:Name>
                  ...
                  <ns9:Location>                    
                    ...
                    <xsl:choose>
                      <xsl:when test='normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N406) != ""'>
                        <ns9:ID>
                          <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N406)"/>
                        </ns9:ID>
                      </xsl:when>
                      <xsl:otherwise>
                        <ns9:ID>
                    ...
                    <ns9:Address>
                      <ns9:AddressLine>
                        ...
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N301)"/>
                      </ns9:AddressLine>
                      <ns9:AddressLine>
                        <xsl:attribute name="sequence">
                          <xsl:value-of select="string(2)"/>
                        </xsl:attribute>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N302)"/>
                      </ns9:AddressLine>
                      <ns9:CityName>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N401))"/>
                      </ns9:CityName>
                      <ns9:CountrySubDivisionCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N407))"/>
                      </ns9:CountrySubDivisionCode>
                      <ns9:CountryCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N404))"/>
                      </ns9:CountryCode>
                      
                      <!-- As per discussion with Ryan on 27th Sep, 2011 -->
                      <!-- NaN Change - As per discussion with Ryan on 9th Oct, 2011 -->
                      <xsl:choose>
                        <xsl:when test='(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N403) != "") and (number(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N403)))'>
                          <ns9:PostalCode>
                            <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1N403)"/>
                          </ns9:PostalCode>
                        </xsl:when>
                        <xsl:otherwise>
                          <ns9:PostalCode>
                  ...
                  <ns9:Contact>
                    <ns9:Name>
                      <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER02))"/>
                    </ns9:Name>
          
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER04) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('TELEPHONE')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER04)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER06) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('FAX')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER06)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER08) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('EMAIL')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1PER08)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                  </ns9:Contact>
              ...
              <ns9:DocumentID>
              <ns9:ID>
                <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG06)"/>
              </ns9:ID>
              </ns9:DocumentID>
            </ns9:ContractReference>
            ...
            -->
            <xsl:if test='xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N101)) = "BT"'>
                <ns9:BillToParty>
                  <ns9:PartyIDs>
                    <ns9:ID>
                      <!-- As discussed by Ryan on 4th Oct, 2011 -->
                      <xsl:value-of select='ethCustomXSLT:formatValue(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N104),2.0,80.0,0.0,$Default_N104,$Default_N104)'/>
                      <!--<xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N104)"/>-->
                    </ns9:ID>
                  </ns9:PartyIDs>
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N102))"/>
                  </ns9:Name>
                  <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N201) != ''">
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N201))"/>
                  </ns9:Name>
                  </xsl:if>
                  <!--
                   <ns9:Name>
                  ...
                  <ns9:Location>
                    <ns9:ID>
                      <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N406)"/>
                    </ns9:ID>
                    <ns9:Address>
                      <ns9:AddressLine>
                       <xsl:attribute name="sequence">
                        ...
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N301)"/>
                      </ns9:AddressLine>
                      <ns9:AddressLine>
                        <xsl:attribute name="sequence">
                          <xsl:value-of select="string(2)"/>
                        </xsl:attribute>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N302)"/>
                      </ns9:AddressLine>
                      <ns9:CityName>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N401))"/>
                      </ns9:CityName>
                      <ns9:CountrySubDivisionCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N407))"/>
                      </ns9:CountrySubDivisionCode>
                      <ns9:CountryCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N404))"/>
                      </ns9:CountryCode>
                      
                      <!-- As per discussion with Ryan on 27th Sep, 2011 -->
                      <!-- NaN Change - As per discussion with Ryan on 9th Oct, 2011 -->
                      <xsl:choose>
                        <xsl:when test='(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N403) != "") and (number(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N403)))'>
                          <ns9:PostalCode>
                            <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4N403)"/>
                          </ns9:PostalCode>
                        </xsl:when>
                        <xsl:otherwise>
                          <ns9:PostalCode>
                  ...
                  <ns9:Contact>
                    <ns9:Name>
                      <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER02))"/>
                    </ns9:Name>
          
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER04) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('TELEPHONE')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER04)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER06) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('FAX')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER06)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER08) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('EMAIL')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD4PER08)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                  </ns9:Contact>
            ...
            <!-- NotFound except HD6N101 HD6N102 HD6N201 -->
              <xsl:if test='xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N101)) = "CA"'>
                <ns9:CarrierParty>
                  <ns9:PartyIDs>
                    <ns9:ID>
                      <!-- As discussed by Ryan on 4th Oct, 2011 -->
                      <xsl:value-of select='ethCustomXSLT:formatValue(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N104),2.0,80.0,0.0,$Default_N104,$Default_N104)'/>
                      <!--<xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N104)"/>-->
                    </ns9:ID>
                  </ns9:PartyIDs>
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N102))"/>
                  </ns9:Name>
                  <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N201) != ''">
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N201))"/>
                  </ns9:Name>
                  </xsl:if>
                  <!--
                   <ns9:Name>
                  ...
                  <ns9:Location>
                    <ns9:ID>
                      <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N406)"/>
                    </ns9:ID>
                    <ns9:Address>
                      <ns9:AddressLine>
                       <xsl:attribute name="sequence">
                        ...
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N301)"/>
                      </ns9:AddressLine>
                      <ns9:AddressLine>
                        <xsl:attribute name="sequence">
                          <xsl:value-of select="string(2)"/>
                        </xsl:attribute>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N302)"/>
                      </ns9:AddressLine>
                      <ns9:CityName>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N401))"/>
                      </ns9:CityName>
                      <ns9:CountrySubDivisionCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N407))"/>
                      </ns9:CountrySubDivisionCode>
                      <ns9:CountryCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N404))"/>
                      </ns9:CountryCode>
                      
                      <!-- As per discussion with Ryan on 27th Sep, 2011 -->
                      <!-- NaN Change - As per discussion with Ryan on 9th Oct, 2011 -->
                      <xsl:choose>
                        <xsl:when test='(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N403) != "") and (number(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N403)))'>
                          <ns9:PostalCode>
                            <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6N403)"/>
                          </ns9:PostalCode>
                        </xsl:when>
                        <xsl:otherwise>
                          <ns9:PostalCode>
                  ...
                  <ns9:Contact>
                    <ns9:Name>
                      <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER02))"/>
                    </ns9:Name>
          
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER04) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('TELEPHONE')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER04)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER06) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('FAX')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER06)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER08) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('EMAIL')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD6PER08)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                  </ns9:Contact>
              ...
              <xsl:choose>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB06)) = 'oa'">
                    <ns9:IncotermsCode>
                      <xsl:value-of select="string('FOB ORIGIN')"/>
                    </ns9:IncotermsCode>
                  </xsl:when>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB06)) = 'de'">
                    <ns9:IncotermsCode>
                ...
                <xsl:choose>
                <!-- NotFound -->
                  <xsl:when test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB05) != ''">
                    <ns9:PlaceOfOwnershipTransferLocation>
                      <ns9:Description>
                        <xsl:value-of select="concat('INCO2010:',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB05),':',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB07))"/>
                      </ns9:Description>
                    </ns9:PlaceOfOwnershipTransferLocation>
                  </xsl:when>
                  <xsl:otherwise>
                    <ns9:PlaceOfOwnershipTransferLocation>
                      <ns9:Description>
                        <xsl:value-of select="concat('EMR2006',':',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB07))"/>
                      </ns9:Description>
                    </ns9:PlaceOfOwnershipTransferLocation>
                  </xsl:otherwise>
                </xsl:choose>
                <xsl:choose>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB01)) = 'pp'">
                    <ns9:FreightTermCode>
                      <xsl:value-of select="string('PREPAID')"/>
                    </ns9:FreightTermCode>
                  </xsl:when>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB01)) = 'cc'">
                    <ns9:FreightTermCode>
                      <xsl:value-of select="string('COLLECT')"/>
                    </ns9:FreightTermCode>
                  </xsl:when>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB01)) = 'pc'">
                    <ns9:FreightTermCode>
                      <xsl:value-of select="string('PREPAID&amp;ADD')"/>
                    </ns9:FreightTermCode>
                  </xsl:when>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB01)) = 'tp'">
                    <ns9:FreightTermCode>
                      <xsl:value-of select="string('THIRDPARTY')"/>
                    </ns9:FreightTermCode>
                  </xsl:when>
                  <xsl:when test="xp20:lower-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1FOB01)) = 'pb'">
                    <ns9:FreightTermCode>
            ...
            <ns9:PaymentTerm>
               <ns9:Term>
                <ns9:ID>
                  <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1ITD12)"/>
                </ns9:ID>
                <ns9:Description>
                  <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD1ITD12)"/>
                </ns9:Description>
            ...
            <xsl:if test='xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N101)) = "SO"'>
                <ns9:BuyerParty>
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N102))"/>
                  </ns9:Name>
                  <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N201) != ''">
                  <ns9:Name>
                    <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N201))"/>
                  </ns9:Name>
                  </xsl:if>
                  <!--
                   <ns9:Name>
                  ...
                  <ns9:Location>
                    <ns9:ID>
                      <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N406)"/>
                    </ns9:ID>
                    <ns9:Address>
                      <ns9:AddressLine>
                       <xsl:attribute name="sequence">
                        ...
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N301)"/>
                      </ns9:AddressLine>
                      <ns9:AddressLine>
                        <xsl:attribute name="sequence">
                          <xsl:value-of select="string(2)"/>
                        </xsl:attribute>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N302)"/>
                      </ns9:AddressLine>
                      <ns9:CityName>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N401))"/>
                      </ns9:CityName>
                      <ns9:CountrySubDivisionCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N407))"/>
                      </ns9:CountrySubDivisionCode>
                      <ns9:CountryCode>
                        <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N404))"/>
                      </ns9:CountryCode>
                      
                      <!-- As per discussion with Ryan on 27th Sep, 2011 -->
                      <!-- NaN Change - As per discussion with Ryan on 9th Oct, 2011 -->
                      <xsl:choose>
                        <xsl:when test='(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N403) != "") and (number(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N403)))'>
                          <ns9:PostalCode>
                            <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5N403)"/>
                          </ns9:PostalCode>
                        </xsl:when>
                        <xsl:otherwise>
                          <ns9:PostalCode>
                  ...
                  <ns9:Contact>
                    <ns9:Name>
                      <xsl:value-of select="xp20:upper-case(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER02))"/>
                    </ns9:Name>
          
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER04) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('TELEPHONE')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER04)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER06) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('FAX')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER06)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                    <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER08) != ''">
                    <ns9:Communication>
                      <ns9:ChannelCode>
                        <xsl:value-of select="string('EMAIL')"/>
                      </ns9:ChannelCode>
                      <ns9:Text>
                        <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HD5PER08)"/>
                      </ns9:Text>
                    </ns9:Communication>
                    </xsl:if>
                  </ns9:Contact>
            ...
            <ns9:ReleaseNumber>
              <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDBEG04)"/>
            </ns9:ReleaseNumber>
            <ns9:UserArea>
              <ns9:CustomPurchaseOrderUserArea>
                <ns9:CustomPurchaseOrderHeaderUserArea>
                  <ns9:EXCHRATE>
                    <xsl:value-of select="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDCUR03)"/>
                  </ns9:EXCHRATE>
                  <xsl:if test="normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDCUR08) != ''">
                  ...
                  <ns9:ExchangeRateDate>
                    <xsl:value-of select="ethCustomXSLT:getISODateFromEDI(normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDCUR08),'NO_TIME','',normalize-space(/ns0:PurchaseOrder/ns0:Line[1]/ns0:HDCUR08))"/>
                  </ns9:ExchangeRateDate>
                  </xsl:if>
                </ns9:CustomPurchaseOrderHeaderUserArea>
              </ns9:CustomPurchaseOrderUserArea>
          ...
          <xsl:if test="$POCO_HDR_STATUS != 'CANCEL'">
            <xsl:for-each-group select="/ns0:PurchaseOrder/ns0:Line" group-by="ns0:LN1PO101">
            <xsl:for-each select="current-group()">
            <!-- For "21st Sep, 2011 - Ryan - if there is NO Schedule, dont map the Line" -> We dont have any mapping for this in here as it is a Flat File -->
            <xsl:variable name="currentPOLineNumber" select="position()"/>
            <ns9:PurchaseOrderLine>
              ...
              <xsl:for-each-group select="." group-by="ns0:LN1SCH12">
              <xsl:for-each select="current-group()">
